    ...
    <FormWrapper name="Registerirung">
      <div class="flex flex-col w-full md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-8 md:p-10 2xl:p-12 3xl:p-14 bg-[#ffffff] rounded-2xl shadow-xl">
        ...
        <form class="flex flex-col">
          ...
          <TextInput placeholder="Brad Pitt is Handsome" lableName="call Brad pitt">
            <EmailIcon/>
          </TextInput>
          <div class="pb-2">
            <label
          ...
          <button
            type="submit"
            class="w-full text-[#FFFFFF] bg-[#4F46E5] focus:ring-4 focus:outline-hidden focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-6"
          >
            Sign Up
          </button>
